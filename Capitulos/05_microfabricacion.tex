...
\section{Microfabricación de los sensores}\label{sec:microfabricaci_n_de_los_sensores}
    ...
    \subsection{Incompatibilidad \textit{top-down/bottom-up}}
  			...
  			El estudio de porqué en estos sistemas calcinados la respuesta era muy diferente a la reportada, se encaró de forma sistemática. Se plantearon cuatro hipótesis: 1) contaminación de los reactivos, 2) poros bloqueados, 3) difusión de impurezas producto de la calcinación y, 4) reestructuración de la superficie de los electrodos de Au por el tratamiento térmico.
  			...
  			Para evaluar las hipótesis de contaminantes que difunden hacia la superficie y reestructuración del Au, ambos fenómenos debido a la temperatura de calcinacinación, se llevaron a cabo experimentos con muestras control, las cuales consistieron en electrodos de Au sometidos a calcinación pero sin depositar películas mesoporosas sobre ellos. En resumen se sometió los electrodos de Au desnudos a condiciones de humedad y temperatura idénticos a las utilizadas en el proceso de síntesis de las \pdm\space (ver el proceso descrito en la sección \ref{sec:cond_y_extr}, pág. \pageref{sec:cond_y_extr}). La respuesta electroquímica seguía siendo defectuosa, por lo que se consolidaron las hipótesis de difusión de contaminantes o reestructuración producto de la temperatura a la que fueron sometidos los electrodos (\SI{350}{\celsius}).

  			Con el objetivo de validar una u otra hipótesis se realizaron una serie de caracterizaciones sobre las películas delgadas de Au con el objetivo de comprender como fueron afectadas por el tratamientos térmico.
		...
		\subsubsection{Difusión de impurezas}
		   ...
		   Con estos resultados y lo expuesto anteriormente, queda claro que la respuesta anómala es debida a una capa superficial, generada por un proceso difusivo durante el tratamiento térmico. Este hecho dificulta la transferencia electrónica entre sonda-electrodo, alejándose de la idealidad y generando una separación de potenciales entre picos anódico y catódica. Como consecuencia directa se obtiene una respuesta EQ deficiente y no reproducible.  y llevo al desarrollo de bajas T. A pesar que se vio que el problema son las impurezas en el Au, también se se que es posible la difusión y la reestrcutucion. Hay que tener cuidado con la capa de adherencia, con la pureza de esta 
