...
\section{Síntesis de películas delgadas mesoporosas}\label{sec:sintesis_mesoporosos}	
	...
	\vspace*{-0.7cm}\subsection{Depósitos de las películas delgadas mesoporosas}\label{sec:deposito_pdm}
			...
			Los mejores resultados se obtienen aplicando al inicio una rampa de velocidad moderada para formar un depósito relativamente grueso y uniforme. Una vez formada esta capa uniforme se lleva a la velocidad final para favorecer la corriente de aire sobre el depósito y llegar al espesor final. Bajo estas condiciones el espsor puede ser calculado por la ecuación \ref{eq:espesor_pdm}\cite{zhang2010}, donde $d(t)$ es el espesor en función del tiempom.......
					...
					\begin{equation}
						d(t)=\frac{h_0}{\sqrt{1+\frac{4 \rho \omega^2 h_0^2 t}{3 \eta}}}
						\label{eq:espesor_pdm}
					\end{equation}

			Dicha ecuación no siempre es fácil de aplicar en la práctica y en general se establece relación entre el espesor resultante y las condiciones experimentales.
