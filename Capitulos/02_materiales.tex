...
\section{Microscopías}\label{sec:micros}
	...
	\subsection{Microscopía con iones de galio focalizados (FIB)}\label{sec:FIB}
		...
		Consiste en el bombardeo de la muestra con iones de galio para desplazar los átomos de la misma. El Ga$^{\circ}$ (que se almacena en en un reservorio en la cabeza de la columna) se licua y se ioniza para dar lugar a los iones de Ga${^+}$, los cuales mediante un sistema de lentes electromagnéticas (similar al usado en MEB) son acelerados y focalizados sobre la muestra. 

\begin{center}
		\begin{figure}[h!]
			  		  
			  		  \begin{subfigure}[t]{\textwidth}
			  		  \includegraphics[width=0.6\textwidth]{Esquemas/sem-fib.pdf}
			  		  \end{subfigure}
			  		  \begin{subfigure}[t]{0.495\textwidth}
