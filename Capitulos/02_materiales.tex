...
\section{Síntesis de películas delgadas mesoporosas}\label{sec:sintesis_mesoporosos}	
	...
	\subsection{Elipsometría}\label{sec:elipso}
		...
		La figura \ref{} ejemplifica la adsorción de agua medida por PEA para una película .........
		%Zr0.8Ce0.2O2 calcinado a 350°C. 
		La curva resultante corresponde a una isoterma tipo IVa, con ciclo de histéresis tipo H2b. Este tipo de isoterma es la más frecuente en este trabajo. El ciclo de histéresis indica la presencia de mesoporos, cuyo llenado se produce por condensación capilar. \cite{Gregg1967}
