...
\section{Mediciones electroquímicas}\label{sec:medidas_eq}
			...
			Las mediciones electroquímicas constituyen una parte central de este trabajo. Se hizo uso de dos tipos de técnicas voltamperométricas: de corriente continua y de corriente alterna. Para algunos de los caso de más difícil interpretación se recurrió a la simulación de voltametrías por elementos finitos. 
	 ...
	 \subsection{Celdas electroquímicas}	
			...
			Las mediciones se llevaron a cabo sobre dos ensamblados experimentales diferentes. El primero de ellos fue utilizado durante los estadios más tempranos de la tesis, sobre electrodos sin diseño transferido. Para este armado se preparó una celda fabricada en acrílico, con un volumen aproximado de \SI{3}{\ml} y un orificio en la parte inferior al cual se le pueden adaptar sellos de polipropileno de diferentes diámetros para evitar fugas de la fase líquida. Se utilizó un sello de \SI{1}{\mm} de radio el cual determinó el área geométrica en \SI{3.15}{\mm^{2}}. La celda se llena con la solución que contiene la sonda electroquímica por la parte superior y de forma entrar contacto con el electrodo. Éste montaje experimental precisó utilizar ER y CE externos. En la figura \ref{fig:celda}a se expone una fotografía de este sistema. 
     ...
     %\subsection{Caracterización de los electrodos}
