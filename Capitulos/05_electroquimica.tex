...
%------------------------------------------------------------------------------
 ...
 \chapter{Electroquímica y transporte en los sensores}
...
\section{Transporte de sondas: exclusión, permeación y preconcentración}
	...
	\subsection{Caso 2: sonda de carga neutra}
		...
		\begin{figure}[ht]
		        ...
		        \caption[Permeación ferroceno metanol en \pdmF]{Respuesta compartiva de un electrodo de Au recubierto con \pdmF\space y sin recubrir frente a una sonda \fc \SI{1}{\milli\Molar} en \SI{0.1}{\Molar} de KCl contra ESC.}
