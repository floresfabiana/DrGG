...
\section{Transporte de sondas en \pdm. Resultados preliminares}
	...
	\subsection{Caso 3. Sonda con carga positiva: \texorpdfstring{\aminorutenioCompleto}{aminorutenio}}
		...
		Se pueden representar las reacciones de adsorción y las de oxidación\textbar reducción como un ciclo termodinámico donde $K_R$ es la constante de adsorción de la especie reducida, $K_O$ es la constante de adsorción de la especie oxidada, $E^0_{ads}$ es el potencial formal de la especie adsorbida y $E^0_{sol}$ al de la especie oxidada.\cite{ybarra2007}

		Por lo tanto, el desplazamiento antes mencionado se debe a la suma de un término extra al potencial formal de la sonda libre, producto del equilibrio de adsorción de las especies reducidas y oxidadas en la película mesoporosa ($K_R/K_O$) según\cite{Wi2000}:

				\begin{equation}
				E^0_{ads} = E^0_{sol}-\frac{RT}{nF}\ln \left(\frac{K_R}{K_O}\right)
				\end{equation}
