...
\section{Métodos alternativos de síntesis de \pdm}
	...
	\subsection{Método por calcinación}
	 ...
	 \subsection{Método prolongado}
	 	 ...
	 	 Este tratamiento se basó en tiempos de condensación prolongados. Luego de la estabilización de las \pdm\space en cámara de humedad se dejó \SI{130}{\celsius} por el término de 7 para llevar a cabo la extracción del surfactante.

	 	 Se lograron sintetizar sobre silicio películas homogéneas, sin discontinuidades ni grietas y de poros bien formados para ambos surfactantes. Cuando se utilizó Au como soporte, solo se obtuvieron películas de buen aspecto para aquellas estructuradas con F127. Para las estructuradas con CTAB se observaron grietas y sectores enteros completamente desprendidos de los electrodos. Nuevamente, al igual que en el tratamientos anterior, este hecho sugiere que la micelas de CTAB impiden la adhesión de las \pdmC\space a los electrodos (figuras \ref{fig:Microscopia_F127_prolongado} y \ref{fig:Microscopia_CTAB_prolongado}).
