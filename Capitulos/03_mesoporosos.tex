...
\section{Introducción}
	...
	La gran mayoría de los autores emplean temperaturas típicamente entre \SI{350}{\celsius} y \SI{600}{\celsius} para producir \pdm. Dicho rango de temperatura tiene como ventaja que promueve la condensación del óxido y, a su vez, calcina el surfactante (materia orgánica) dando lugar a la formación de los poros.\cite{Kresge1992,Beck1992,DiRenzo1997}  Sin embargo para obtener un control adecuado sobre la estructura final, antes de la calcinación, se debe estabilizar el arreglo micelar, es decir la estructura formada por el molde supramolecular.  En 1996 Huo y col.\cite{Huo1996} advierten sobre éste hecho y estudiaron la estructura  de silice ......... luego de la calcinación para diferentes tratamientos de estabilización del cristal líquido.

	Desde entonces fueron muchos los trabajos que se concentran en el control de la quimica supramolecular y la fisicoquimica de la qiomica sol-gel. Diferentes tratamientos y stategias combinados son las herramientas para el control de la estructura. Alguno de los mas relevantes en general y en partícula para este trabajo son, pH de sintesis\cite{}, control y ciclos de humedad \cite{}, tiempos de envejecimiento\cite{} y rampas de tempearuta son vareibles\cite{}.....son varibles muy estudiadas para el control de la mesoestructura de los poros y las estrcuturas resultante para la calcinacion posterior.  
