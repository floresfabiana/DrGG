...
\section{Métodos alternativos de síntesis de \pdm}
	...
	\subsection{Método por calcinación}
	 ...
	 \subsection{Método simplificado}
		...
		En el análisis por microscopía se aprecia que las \pdmF\space sometidas a éste tratamiento se adhieren bien y quedan bien formadas, sin grietas ni discontinuidades y con poros bien formados sobre la superficie para ambos sustratos, tanto sobre Au como sobre Si \ref{fig:Microscopia_F127_simplificado}. Las \pdmC\space sobre silicio también adhieren bien y no presentan grietas. El problema se presenta para las \pdm\space sobre Au (figura \ref{fig:Microscopia_CTAB_simplificado}), en las cuales la estructura presenta grietas y discontinuidades, posiblemente se deba al hecho de la adsorción del bromuro sobre el Au, tema que ya fue discutido en la sección \ref{sec:adherencia}, pág. \pageref{sec:adherencia}. 
		...
		En el caso del tratamiento simplificado, cuando las películas mesoporosas son estructuradas con CTAB, se observan que estám bien formadas sobre silicio pero no sobre Au . Allí la estructura presenta grietas y discontinuidades, posiblemente se deba al hecho de la adsorción del bromuro sobre el Au, ya discutido en la sección \ref{sec:adherencia}, pág. \pageref{sec:adherencia}.
