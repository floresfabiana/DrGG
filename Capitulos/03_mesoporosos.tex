			...
			\begin{figure}[th!]
				   ...
				   \begin{figure}[ht!]
				        	...
				        	\includegraphics[width=\textwidth]{Graficos/histogramas-indice.pdf}
				       		\end{subfigure}
				     		\caption[Comparación del grado de condensación de \pdm]{Comparación de las magnitudes mas relevante (tamaño de poros, cuellos, volumen poroso e índice de refracción), extraídas del análisis por EPA, con el ánimo de comparar el grado de condensación de las películas delgadas mesoporosas en base sílice, estructuradas con F127 (SF) y CTAB (SC).}
