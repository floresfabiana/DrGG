...
\section{Introducción}
	...
	La gran mayoría de los autores emplean temperaturas típicamente entre \SI{350}{\celsius} y \SI{600}{\celsius} para producir \pdm. Dicho rango de temperatura tiene como ventaja que promueve la condensación del óxido y, a su vez, calcina el surfactante (materia orgánica) dando lugar a la formación de los poros.\cite{Kresge1992,Beck1992,DiRenzo1997}  Sin embargo, para obtener un control adecuado sobre la estructura final, antes de la calcinación se debe estabilizar el arreglo micelar, es decir la estructura formada que actúa de molde supramolecular. Es abundante en la literatura los trabajos que se concentran en optimizar condiciones experimentales para estabilizar diferentes organizaciones espaciales de poros, empleando diferentes precursores con diversos surfactante\cite{Huo1996,Herregods2013,Grosso2001}. Existen muchos tratamientos y estrategias de síntesis para lograr dicho control basados en pH o variaciones del mismo durante la sintesis\cite{Doshi2000a,Soler-Illia2011,Boissiere2000,Huo1996,GonzalezSolveyra2017,Ichinose2002}, ciclos de P$_\text{H$_2$O}$\cite{Soler-Illia2012}, tiempos de envejecimiento\cite{} y rampas de temperatura\cite{} por citar algunas de las variables mas influyentes. En general todos estas etapas pre-calcinación de los citados trabajos son a temperaturas moderadas, alrededor de los \SI{100}{\celsius} y destacan la importancia de controlar estás variables y poder mantener la integridad estructural de la fase inorgánica luego de la calcinación. 

	Existen pocas publicaciones donde la extracción del molde supramolecular por métodos alternativos a la calcinación sea el eje central del trabajo. En el año 2000 Clark y col. emplean UV ($\lambda=$\SI{187-254}{\nm}) para generar una atmósfera oxidante rica en O$_3$ de forma de remover el surfactante. El método lo aplican con éxito sobre películas de silice estructuradas con Brij56, sin embargo el arreglo de poros muda de hexagonal a cúbica luego de la exposición al UV. Otro antecedente son los trabajos de Huang en 2002 y Zhang en 2005. El primero emplea plasma de .... sobre \pdm\space de TiO$_2$ y el segundo adapta el método para utilizarlo sobre mesoporosos en base sílice. Ambos trabajos llegan a la conclusión de que la estructura se desordena, cambia el grado de porosidad y el control sobre la estructura es poco predecible. 

	Los métodos con luz.... plasma.... poco espesor.... adsorccion.....

	quimicos, de extraccion....

	 trabajo .... aplicado a TiO2 que luego .... adpata para silica, 
	...
	%Es abundante la bibliografía sobre los parámetros a controlar para obtener distintas geometrías (\textit{p6m,Ia3d,Pm3n,Immc}) con distintos centros metátlicos y diferentes surfactantes.   


	%En 1996 Huo y col.\cite{Huo1996} publicaron un trabajo sobre las estructuras resultantes luego calcinar materiales basado en silice. Estudiaron fundamentalmente MCM-41 (2d hexagonal, \textit{p6m}), MCM-48 (cubica, \textit{Ia3d}), MCM-50 (lamellar), SBA-1 (cubica \textit{Pm3n}), SBA-2 (3d hexagonal, \textit{P6}$_3$\textit{/mmc}), and SBA-3 (hexagonal, \textit{6m}) luego de la calcinación, bajo diferentes tratamientos de estabilización del cristal líquido utilizando diversos surfactantes (MCM es la sigla utilizada por científicos de \textit{Mobil Oil Research and Development} para \textit{mesoporous molecular sieves}, SBA es la sigla adoptada por científicos de la Universidad de Santa Barbara cuyo significado de \textit{Santa Barbara Amorphous type material}). 

	
	
	A pesar de estos trabajos citados, son pocos los procesos donde la extracción del molde supramolecular se lleve a temperaturas por temperaturas por debajo de 200ºC. 

	Podemos presentar los tabajo.... UV profundo, ozono, en tio2.... plasma...
