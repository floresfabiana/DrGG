...
\section{Métodos alternativos de síntesis de \pdm}
	...
	\subsection{Método por calcinación}
	 ...
	 \subsection{Comparación de resultados}
			...
			\begin{tabular}{>{\raggedright\arraybackslash}m{1.2cm}>{\centering\arraybackslash}m{1cm}>{\centering\arraybackslash}m{1cm}>{\centering\arraybackslash}m{1cm}>{\centering\arraybackslash}m{1cm}>{\centering\arraybackslash}m{1cm}>{\centering\arraybackslash}m{1cm}>{\centering\arraybackslash}m{1.53cm}} 
			\toprule
			     ...
			     SimSF   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ \midrule
				 ProSC   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ 
				 ProSF   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ \midrule
				 VacSC   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ 
				 VacSF   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ \midrule
				 ÁciSC   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ 
				 ÁciSF   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ \midrule
				 AlcSC   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\ 
				 AlcSF   & B  & m  & 5  & 2  & 40\% & 220 & 1.25 \\
			\bottomrule
			\end{tabular}\vspace*{2pt}
