...
\section{Breve reseña sobre nanotecnología}
    ...
    Esta tesis tiene por objetivo fabricar sensores utilizando electroquímica como técnica de detección. La fabricación de los mismos se realiza en base a procesos \textit{top-down} para escalar y miniturizar los electrodos y procesos \textit{bottom-up}, quimica sol-gel y autoensamblado inducido por evaporación, con el fin sintetizar la película activa. El diagrama de  de Venn de la figura \ref{fig:sensores} muestran los elementos necesarios para la fabricación de los sensores electroquímicos basados en películas delgadas mesoporosas. 
 	...
 	A continuación se exponen los objetivos y motivaciones del presente trabajo de tesis. En las secciones subsiguientes se tratan brevemente los fundamentos teóricos de cada una de las áreas temáticas exploradas para el desarrollos de la plataforma de sensores electroquímicos en base a películas delgadas mesoporosas.	    

\section{Motivación y objetivo}

	El presente trabajo de tesis se desarrolló en el Instituto Nacional de Tecnología Industrial (INTI), cuyas principales actividades son: certificación de productos, metrología industrial, científica y legal, y generación y transferencia	de innovación tecnológica a la industria. Es, dentro de este contexto, que surge el desafío de desarrollar un dispositivo en base nanotecnologica. 

	El objetivo principal de la tesis es desarrollar una plataforma de sensores electrqoquimicos basados en películas delgadas meosporosos. Las etapas y objetivos intermedios para la fabricación de los sensores se pueden resumir en los siguientes items:

	\begin{itemize}
		
		\item Despositar y condensar peliculas delgadas mesoporosas de óxidos de silicio estructuradas con F127 y CTAB sobre silicio, peliculas delgadas de oro y midroelectrodos.  
		\item Desarrollar métodos para condensar la estructura inorganica y extraer el agente moldeante a bajas de temperaturas, de forma de evitar temperaturas de calcinacion. 

		%\item Compatibilidad top-bottom  . Desarrollo de peliculas meso a baja temperatura

		\item Estudio de propiedades de transporte mediante experimentos de electroquimica y imulacion computacional por metodos de elemetos finitos.

		\item Miniaturizacion de los electrodos, estudios de escalabilidad, optimización de los diseños y resolver problemas de compatibilidad top-down/bottom-up.

		\end{itemize}	

		%miniaturalizarlos y fabricarlos mediante procesos escalables, con el objetivo último de generar un prototipo sensible de ser transferidos al sector industrial.
...
\section{Minuaturización y escalabilidad}\label{sec:microfabricacion}\label{sec:intro_fotolito}
