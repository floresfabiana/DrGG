...
\section{Películas delgadas mesoporosas}\label{sec:mesoporosos}
	...
	El concepto de Autoensamblado Inducido por Evaporación, abreviado AEIE, fue introducido por el grupo de Brinker a fines de la década de 1990.19,20 En términos generales, consiste en la forma- ción de estructuras supramoleculares de surfactantes, como las mostradas en la Figura 1.5, ocu- rrida por la evaporación del solvente en el que el polímero se halla inicialmente disuelto. Este proceso ocurre cooperativamente con la interacción y condensación de los bloques de construc- ción inorgánicos. En la actualidad, este concepto constituye un método habitual de obtención de films delgados mesoporosos ordenados,38 así como micropartículas, monolitos, etc.11 En la Figura 1.6 se muestran imágenes de microscopía de transmisión electrónica de óxidos mesoporosos ob- tenidos por este método, junto con una representación de la estructura de poros obtenida en cada caso.

	Un esquema del proceso de obtención de un film mesoestructurado a través del depósito de un sol sobre un sustrato por la técnica de dip coating se presenta en la Figura 1.7. A continuación se de- finen las palabras clave enunciadas en la oración precedente, en el contexto de la formación de
	films delgados mesoestructurados: ? El sol está formado por una mezcla del/los precursores inorgánicos, el surfactante, agua, moderadores de la reactividad, y un solvente volátil.
	
	? El sustrato es el material a recubrir, el cual debe interactuar favorablemente con el sol de manera de que éste quede adherido para formar el film delgado.
	
	? La técnica de dip coating involucra sumergir el sustrato y extraerlo a velocidad controlada.

	En el sol, el surfactante se halla en concentraciones menores que la cmc. Durante la extracción, a medida que el solvente volátil se evapora, el surfactante se concentra, supera la cmc y por lo tanto forma micelas, las cuales se organizan en estructuras supramoleculares específicas unos segundos después del depósito. La presencia de la interfase líquida sol-sustrato genera típicamente una orientación preferencial del arreglo supramolecular formado por las micelas del surfactante, ori- ginando estructuras cuyos planos paralelos al sustrato se encuentran mono-orientados.18 En ge- neral, se establece una orientación tal que proporcione un máximo grado de interacción con el sustrato sustrato mediante el contacto con el plano más denso del arreglo tridimensional formado.45

	Es posible realizar predicciones en cuanto al arreglo que formarán los surfactantes a través de modelos que consideran la fracción de volumen del polímero en cuestión. Esta fracción volumé- trica está definida como = Vpol/(Vpol + Vinorg), donde Vpol corresponde al volumen que ocupa el polímero, y Vinorg el volumen de todas las especies incluidas en el sol excepto el solvente volátil (fundamentalmente precursores de metales, ácido, agua).38,46 Esto establece la posibilidad de un control denominado “termodinámico”, pues básicamente está fundamentado en los diagramas ternarios de los surfactantes.10 Al finalizar el depósito, si el esqueleto inorgánico se halla poco condensado, el film es un material fluido que posee la capacidad de evolucionar de formas diferentes cuando es sometido a condicio- nes ambientales diversas. Este estado se denomina “estado estacionario modulable”47 ya que, por ejemplo, puede modificarse el arreglo tridimensional del surfactante al exponer el film a diferen- tes condiciones de humedad ambiente.48 En este sentido, no sólo es necesario controlar la reacti- vidad de los precursores inorgánicos durante y después del depósito, sino también las condiciones ambientales ambientales a en las cuales se depositan los films. Además, la energía asociada a los procesos de  formación de estructuras organizadas por parte de las micelas del surfactante es del orden de kT, y por esta razón, el control sobre los factores cinéticos es también de suma importancia.33 Debido a esto, el tratamiento posterior al depósito también debe ser cuidadosamente controlado y selec- cionado para obtener resultados reproducibles y, por lo tanto, caminos sintéticos robustos. En función de la composición inicial del sol, del tipo de surfactante, de la química de los precursores, de la humedad relativa ambiente, del tipo de sustrato, etc., es posible obtener resultados comple- tamente diferentes en cuanto a la evolución temporal de la mesoestructura.38,48-50 Un análisis sis- temático de cada una de estas variables resulta clave para establecer cuáles son las condiciones óptimas para obtener un tipo de material en particular. Con tipo de material se hace referencia no sólo al óxido que conforma las paredes, sino al arreglo tridimensional de los poros, que está dado por el estado de organización de las micelas previo al momento en el cual se eliminan por calcina- ción. En el Capítulo 4 se analizará en detalle cómo el post-procesamiento y la composición de la solución precursora influyen en las características de FDM de titania, zirconia y sílice, y de qué manera los resultados correlacionan con la química de los precursores utilizados

			\begin{figure}[h!]
 				\begin{center}
 				\includegraphics[width=0.5\textwidth]{Esquemas/autoensam.pdf}
 				\caption[Proceso de autoensamblado inducido por evaporación (AEIE)]{Proceso de autoensamblado inducido por evaporación (AEIE) en la técnica de \textit{dip-coating}. La evaporación del solvente favorece la formación de micelas mas allá de la cmc formado el cristal líquido. Un proceso similar ocurre cuando se aplica la ténica de \text{spin-coating}}
 		   		\label{fig:autoensam}
 		    	\end{center}
 		    	\end{figure}
