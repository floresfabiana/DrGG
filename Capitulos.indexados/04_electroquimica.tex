...
\subsection{Funcionalización}
	...
	En esta sección se exponen los resultados obtenidos al incluir y anclar grupos moleculares dentro de los poros. El objetivo de realizar dichas funcionalizaciones es cambiar la naturaleza química superficial, de forma de modificar las propiedades permeoselectivas de las películas. 

	Para obtener resultados sólidos sobre fenómenos de transporte\index{transporte} dentro de las películas, que lleven a interpretaciones verosímiles, se necesitan películas donde la estabilidad estructural no esté comprometida. En las secciones precedentes se ha demostrado que la incorporación de un 10\% de Zr\index{circonio} a las películas de SiO$_2$, utilizando el método de síntesis por alto vacío\index{alto@alto vacío}, mejora la estabilidad mecánica y la resistencia química sin perder poder de adsorción\index{adsorción}, incluso frente \pdmF\space calcinadas. Es por ellos que todos los experimentos que se presentan en esta sección fueron realizados con dichos sistemas.

	Las moléculas incorporadas fueron dihexadecilfosfato\index{dihexadecilfosfato} (DHDP) y 3-amino\- propil trietoxisilano (APTES\index{aminopropil@3-aminopropil trietoxisilano}). Dicha elección se basó en trabajos previos donde estudian en detalle la incorporación de estás moléculas, ya sea en películas delgadas mesoporosas de SiO$_2$, Ti\index{titanio}O$2$, Zr\index{circonio}O$_2$ o mixtas.\cite{Calvo2009b,Angelome2008,Fattakhova-Rohlfing2007,Andrieu-brunsen2014,Andrieu-Brunsen2015} Hasta ahora no se han reportado en la literatura trabajos donde se incorporen estas funcionalizaciones sobre electrodos recubiertos con películas delgadas mesoporosas mixtas Zr\index{circonio}$_x$Si$_{1-x}$O$_2$. Además, los resultados expuestos en esta sección cuenta con el plus de que fueron obtenidos en un dispositivo micromaquinado, es decir, que las reacciones de funcionalización\index{funcionalización} se llevaron en electrodos diferentes pero en un único sensor. El capítulo que sigue ahonda en los detalle sobre la fabricación de los sensores.
	
		\subsubsection{Incorporación del DHDP}
	
			La funcionalización\index{funcionalización} con DHDP se llevó a cabo adaptando la reacción utilizada por Angelomé\index{Angelomé}\cite{Angelome2008}. Se utilizó \SI{3}{\milli\Molar} de DHDP sobre películas delgadas de Si$_x$Zr$_{1-x}$O$_2$ (\pdmZ$^P_3$). Las condiciones experimentales se pueden consulta en la sección \ref{sub:funcionalizaci_n_de_las_pdm}, pág. \ref{sub:funcionalizaci_n_de_las_pdm}. En dicho trabajo incorpora DHDP en películas mixtas de Si$_x$Zr$_{1-x}$O$_2$ y Si$_x$Ti$_{1-x}$O$_2$. Se concluye allí que la reacción se trata de una unión débil de complejación superficial entre el fosfonato y el centro metálico, en este caso el Zr\index{circonio}. El esquema de la figura \ref{esq:dhdp-esquema} representa una \pdmZ$^P_3$ luego de ser funcionalizada.

				 \begin{figure}[ht!]	
					\centering
			 	    \includegraphics[width=\textwidth]{Esquemas/funcionalizaciondhdp.pdf}
			        \caption[Funcionalización con DHDP 3mM]{Esquema donde se representa la reacción de DHDP con \pdmZ\space para obtener películas funcionalizadas con DHDP. Adaptación del trabajo \textit{Films delgados mesoporosos de óxidos metálicos, mixtos e híbridos. Hacia un diseño racional de nanomateriales\index{nanomateriales} funcionales.} Tesis de Doctorado, Facultad de Ciencias Exactas y Naturales - UBA, 2008.\cite{Angelome2008}}
			        \label{esq:dhdp-esquema}
			      	\end{figure}

		    Una vez realizada la modificación superficial de las películas se llevaron a cabo sobre las mismas mediciones EQ con \fe\space y \ru. El resultado de la mismas son los voltagramas que se presentan en las figuras \ref{fig:dhdp-vc} y \ref{}. En el caso del \fe\space se ve que luego de llevar a cabo la funcionalización\index{funcionalización} con DHDP, la sonda\index{sonda} negativa logra permear hasta la superficie\index{superficie} del electrodo, mientras que en las \pdmZ\space sin funcionalizar dicha sonda\index{sonda} quedaba totalmente excluida (figura \ref{}).
		    
		    	 \begin{figure}[ht]	
					\centering
			 	    \includegraphics[width=0.70\textwidth]{Graficos/dhdp-FeCN.pdf}
			        \caption[Voltagrama para \pdmF$^P_3$ con FeCN]{voltagramas donde se compara la respuesta .....90 cicloas para cada uno.... etc}
			        \label{fig:dhdp-vc}
			      	\end{figure}

		    El caso del \ru\space 
