...
\subsection{Funcionalización}
	...
	En esta sección se exponen los resultados obtenidos al incluir y anclar grupos moleculares dentro de los poros. El objetivo de dicha incorporación es cambiar el estado de carga superficial de forma de modificar las propiedades permeoselectivas de las películas. 

	Para obtener resultados predecibles y realizar interpretaciones verosimiles se necesitan películas donde la estabilidad estructural no esté comprometida. En las secciones precedentes se ha demostrado que la incorporación de un 10\% de Zr\index{circonio} a las películas de SiO$_2$, utilizando el método de síntesis por alto vacío\index{alto@alto vacío}, mejora la estabilidad mecánica y la resistencia química sin perder poder de adsorción\index{adsorción}, incluso frente \pdmF\space calcinadas. Es por ellos que todos los experimentos que se presentan en esta sección fueron realizados con dichos sistemas.

	Las moléculas incorporadas fueron 3-aminopropil trietoxisilano (APTES\index{aminopropil@3-aminopropil trietoxisilano}) y dihexadecilfosfato\index{dihexadecilfosfato} (DHDP). Dicha elección se basó en trabajos previos donde modifican las propiedades de transporte\index{transporte} como consecuencia de dicha incorporación.\cite{Calvo2009b,Angelome2008,Fattakhova-Rohlfing2007,Andrieu-brunsen2014,Andrieu-Brunsen2015} Hasta el momento no se han reportado en la literatura trabajos donde se incorporen estas funcionalizaciones en películas mesoporosas mixtas Zr\index{circonio}$_x$Si$_{1-x}$O$_2$. Además, los resultados expuestos en esta sección cuenta con el plus de que fueron obtenidos en un dispositivo micromaquinado, es decir, que las reacciones de funcionalización\index{funcionalización} se llevaron en electrodos diferentes pero en un único sensor. El capítulo que sigue ahonda en los detalle sobre la fabricación de los sensores.
