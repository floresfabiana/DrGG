...
\section{Transporte de sonda\index{sonda}s en \pdm}
	...
	\subsection{Caso 3. Sonda de carga positiva: \aminorutenioCompleto}
...
\section{Caso de estudio: ferroceno metanol}\label{sec:difusion}
	...
	\subsection{En sistemas mesoporoso sintetizados a baja temperatura}
		...
		Se exponen en la figura \ref{fig:fcoh_bajaT} los voltagramas resultado de colocar \fc\space (1, 5 y \SI{10}{\milli\Molar}) utilizando como electrodo \pdmF\space condensada y extraída a \SI{130}{\celsius} por el método de alto vacio\index{alto@alto vacío}. 
			\begin{figure}[ht]
				\centering
...
\subsection{Funcionalización}
	...
	Para obtener resultados predecibles y no realizar interpretaciones erróneas se necesitan películas donde la estabilidad estructural no esté comprometida. En las secciones precedentes se ha demostrado que la incorporación de un 10\% de Zr\index{circonio} a las películas de SiO$_2$, utilizando el método de síntesis por alto vacio\index{alto@alto vacío}, mejora la estabilidad mecánica y la resistencia química sin perder poder de adsorción\index{adsorción}, incluso frente \pdmF\space calcinadas. Es por ellos que todos los experimentos que se presentan en esta sección fueron realizados con dichos sistemas.

	Las moléculas incorporadas fueron 3-aminopropil trietoxisilano (APTES\index{aminopropil@3-aminopropil trietoxisilano}) y dihexadecilfosfato\index{dihexadecilfosfato} (DHDP). Dicha elección se basó en trabajos previos donde modifican las propiedades de transporte\index{transporte} como consecuencia de dicha incorporación.\cite{Calvo2009b,Angelome2008,Fattakhova-Rohlfing2007,Andrieu-brunsen2014,Andrieu-Brunsen2015} Hasta el momento no se han reportado en la literatura trabajos donde se incorporen estas funcionalizaciones en películas mesoporosas mixtas Zr\index{circonio}$_x$Si$_{1-x}$O$_2$. Además, cuenta con el plus que las reacciones se llevaron en electrodos diferentes pero en un único sensor. El capítulo que sigue trata con detalle la fabricación de los sensores.
