...
\section{Caso de estudio: \texorpdfstring{\ferroceno}{FeOH}}
	...
	Los resultados de introducir ferroceno metanol\index{ferroceno metanol} (\ferroceno,\fc) en las \pdmF\space ya fueron presentados en la sección \ref{}, pág \pageref{key} del capitulo \ref{chap:Mesoporosos}. Sin embargo, en dicha sección, la discusión se centró en el análisis de la accesibilidad\index{accesibilidad} de la sonda\index{sonda} neutra en las películas, y en base a esto, como se modifica debido a los distintos métodos de deposito y post-tratamientos de las \pdm\space.

	En esta sección se presentan los resultados de la respuesta electroquímica\index{electroquimico} del \fc\space dentro de estos sistemas y se discuten en términos de fenómenos de transporte\index{transporte} y calculo de coeficientes de difusión\index{difusión}.
