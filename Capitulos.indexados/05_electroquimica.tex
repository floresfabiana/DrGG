...
\section{Caso de estudio: \texorpdfstring{\aminorutenioCompleto}{Ru(NH\index{amoniaco}3)CL3}}
	...
	\subsection{Estabilidad de las \pdmF}
		...
		\marginpar{\color{red}{Colocar el grafico de disolucion para Ru 1mM calcinado en Au\index{oro} CNEA\index{CNEA}!! También el grafico de i en funcion de los ciclos}}
