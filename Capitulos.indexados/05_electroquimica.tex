...
\section{Caso de estudio: \texorpdfstring{\ferroceno}{FeOH}}
	...
	Los resultados de introducir ferroceno metanol\index{ferroceno metanol} (\ferroceno,\fc) en las \pdmF\space ya fueron presentados en la sección \ref{}, pág \pageref{key} del capitulo \ref{chap:Mesoporosos}. Sin embargo, en dicha sección, la discusión se centró en el análisis de la de películas delgadas mesoporosas y como cambia la accesibilidad\index{accesibilidad} en función de los distintos tratamientos de condensación\index{condensación} posdeposito.
	En esta sección se presentan los resultados de la respuesta electroquímica\index{electroquimico} del \fc\space en \pdm\space. Se discuten estos resultados en términos de fenómenos de transporte\index{transporte} y modelos válidos aplicables al calculo de coeficientes de difusión\index{difusión} del \fc\space en cada sistema.

	\subsection{En sistemas mesoporosos calcinados}

	En los sistemas calcinados, aquellos en los que se eliminó el surfactante\index{surfactante} sometiendo las peliculas a 350C, la red nanoporosa\index{película!nanoporosa} está mas accesible y mejor interconectada que aquellos que no fueron calcinados (ver capitulo \ref{chap:Mesoporosos}). Por lo tanto, se espera que la respuesta electroquimica de la sonda\index{sonda} neutra sea similar a la respuesta en un un electrodo de Au\index{electrodo!de Au}\index{oro} desnudo. En el voltagrama de la figura .... se muestra que, efectivamente, se comporta de esta forma. Se colocó una solucino de ferrroceno 10mM y se hicieron una serie de voltametrias a diferentes velocidaddes de barrido, con el proposito de calcular el coeficiente de difusion. En el grafico .... se observa la tendencia de ip prop v1/2, lo que indica que se trata de un proceso controlado por difusion. Ahora bien, esta difusion tiene dos contribuciones, una de la sonda\index{sonda} en solucion y otra de la sonda\index{sonda} dentro de los poros. Nostroso calculamos a partir de la ecuacion.... un coeficiente aparente que es una combinacion de ambos, sin embargo este da 2.5e-5 el cual es segun la biliografia un tipo valor para moleculas en solucion.
