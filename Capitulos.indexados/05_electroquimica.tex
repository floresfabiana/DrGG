...
\section{Caso de estudio: \texorpdfstring{\aminorutenioCompleto}{Ru(NH\index{amoniaco}3)CL3}}
	...
	\section{Transporte en \pdm\space mixtas Zr\index{zirconio}/Si}
	 ...
	 \subsection{Exclusión}
	 	 ...
	 	 Al\index{aluminio} introducir Zr\index{zirconio} en las películas delgadas se espera un corrimiento del PI hacia un pH\index{pH} mayor\cite{Kosmulski2014}. Sin embargo al incluir solo un núcleo metálico de Zr\index{zirconio} cada cada diez de Si, esperamos mantener un PI mas próximo al del SiO$_2$ y, consecuentemente, observar propiedades similares a las que ya se presentaron para las \pdmF.
