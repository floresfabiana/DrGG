...
\section{Fotolitografia}\label{sec:intro_fotolito}

\section{implementacion tecnologica}

Integracion, todo en argentina, valor agregado del proceso sol-gel\index{sol-gel}.
