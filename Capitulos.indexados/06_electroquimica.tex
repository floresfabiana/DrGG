...
\section{Adsorcion de sonda\index{sonda}s, exclusion, permeacion}
...
% 				Aca va todas imagenes de elipsoporosimetria\index{elipsoporosimetria} ambiental para el calcinado. tambienSEM\index{SEM} yFIB\index{FIB}. y FTIR,
