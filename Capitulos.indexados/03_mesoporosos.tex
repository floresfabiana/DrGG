...
\section{Introducción}
	...
	También existe una gran variedad de agentes moldeante para establecer el tamaño y la estructura espacial de los poros (F127, P123, Brij58\index{Brij58}\index{Brij58}, CTAB, etc) \cite{angelome2011,schuth2013,Soler-Illia2006,Soler-Illia2002a}. Este trabajo se centró exclusivamente en síntesis de \pdm\space utilizando óxido de silicio\index{silicio!oxido de}\index{silicio} como precursor\index{precursor} para generar la estructura inorgánica. En la mayoría de los casos se utilizó puro, y en algunos combinado con óxido de circonio\index{circonio} (ZrO$_2$). Para controlar el tamaño y estructura espacial de los poros se utilizó el copolímero de bloque Pluronic F127\index{Pluronic F127}, bromuro de hexadeciltrimetilamonio\index{bromuro de hexadeciltrimetilamonio} (CTAB) y un polioxietileno[20] cetil éter (Brij58\index{Brij58}).Esta elección no fue arbitraria, sino que se hizo en base a premisas bien fundamentadas:
		...
		\item Como agente moldeante\index{agente moldeante} se utilizó F127, CTAB y Brij58\index{Brij58}\index{Brij58} de forma de obtener \pdm\space con tamaño de poros bien variados, con diámetros que van de los 10 a los \SI{2}{\nm}.
...
\section{Síntesis de películas delgadas mesoporosas}
	...
	\subsection{Adherencia al sustrato\index{sustrato} de las \pdm}	
		...
		\subsubsection{Estrategias para mejorar la adherencia}\label{sec:adherencia}
			 ...
			 Ambas estrategias para promover la adherencia\index{adherencia} de las \pdm\space son complementarias y compatibles. Esto quiere decir que se puede optimizar el diseño para minimizar la superficie\index{superficie} de electrodos y, a su vez, es posible funcionalizar  con MPTMS las regiones de los electrodos, generando puntos de vinculación entre el mesoporosos y el electrodo. La funcionalización\index{funcionalización} se debe lleva a cabo luego de depositar el Au\index{oro} y antes de realizar el decapado\index{decapar} de la fotorresina\index{fotorresina} (consultar sección \ref{sec:fotolito}, pág. \pageref{sec:fotolito}) y no sobre los sensores\index{sensor} terminados. De esta forma la modificación queda delimitada sólo a las regiones donde están los electrodos, evitando reacciones colaterales como la silanización\index{silanización} del vidrio\index{vidrio} o silicio\index{silicio} con el MPTMS por el extremo del silanol.
