...
\section{Métodos alternativos de síntesis de \pdm}
	 ...
	 \subsection{Comparación de resultados de los tratamientos pos-síntesis}
			 ...
			 \begin{table}[ht!]
			 \caption[Comparación de resultados \pdm]{Resumen de resultados obtenidos por cada una de las técnicas de caracterización, para cada uno de los métodos pos-depósito aplicados a \pdm. Tanto los diámetros de poro\index{poro} ($\varnothing_p$) y cuello\index{cuello de poro} ($\varnothing_c$) como los espesor\index{espesor}es ($e$) están expresando en manómetros.}
			 ...
			 \endgroup
			 %\begin{tabular}{>{\raggedright\arraybackslash}m{1.3cm}>{\centering\arraybackslash}m{0.2cm}>{\centering\arraybackslash}m{0.2cm}>{\centering\arraybackslash}m{0.2cm}>{\centering\arraybackslash}m{0.2cm}>{\centering\arraybackslash}m{0.75cm}>{\centering\arraybackslash}m{0.75cm}>{\centering\arraybackslash}m{0.75cm}>{\centering\arraybackslash}m{0.75cm}>{\centering\arraybackslash}m{0.75cm}>{\centering\arraybackslash}m{0.98cm}} 
			 \addtolength{\tabcolsep}{-2.7pt} 
			 \begin{tabular}{l c@{\hspace{5.95mm}} c c c@{\hspace{4.5mm}} c c c c@{\hspace{6.25mm}} c c c c c c@{\hspace{6.25mm}} c}
			 \toprule
			 ...
			 SimSF & &\checkmark&7,8 & &\checkmark&7,0&-& &7,5 & 3,9$^\dagger$& 30 & 211 & 1,390 & & 36,4 \\ \midrule
			 ProSC & &\checkmark&-   & &\xmark    &-  &-& & 2,5& 2,0 & 41 & 338 & 1,375 & & 44,5 \\ 
			 ProSF & &\checkmark&8,1 & &\checkmark&8,5&-& &8,0 & 4,0$^\dagger$  & 39 & 212 & 1,381 & & 22,7 \\ \midrule
			 VacSC & &\checkmark&-   & &\xmark    &-  &-& &2,2 & 1,7  & 44 & 381 & 1,393 &&  65,5 \\ 
			 VacSF & &\checkmark&8,2 & &\checkmark&8,2&-& &9,0 & 4,0  & 38 & 223 & 1,383 & & 42,5 \\
			 VacZSF& &\checkmark&-   & &\checkmark&-  &-& & -  &  -	 & -  &  -  &    -  &  &  -  \\ \midrule	
			 ÁciSC & &\checkmark&-   & &\xmark    &-  &-& &2,0 & 1,6  & 37 & 340 & 1,386 & &46,0 \\ 
			 ÁciSF & &\checkmark&8,2 & &\xmark    &-  &-& &5,7 & 2,1$^\dagger$  & 31 & 191 & 1,399 & & 28,2 \\ \midrule
			 Al\index{aluminio}cSC & &\checkmark&-   & &\xmark    &-  &-& &2,3 & 1,6  & 46 & 383 & 1,396 & & 47,6 \\ 
			 Al\index{aluminio}cSF & &\checkmark&8,3 & &\xmark    &-  &-& &8,0 & 2,1$^\dagger$ & 32 & 225 & 1,374 &  & 24,5 \\
			\bottomrule
			\end{tabular}
		    \begingroup
		    \subcaption{Parte B: Accesibilidad de sonda\index{sonda}s EQ, espectroscopía IR y observaciones.}
			\endgroup
			\begin{tabular}{l@{\hspace{8mm}} c c@{\hspace{5.95mm}} c@{\hspace{5.95mm}} l@{\hspace{2.85mm}}} 
			\toprule
			...
			\bottomrule
			\end{tabular}\vspace*{2pt}
			\footnotesize{$^*$se evalúa adherencia, grietas, discontinuidades y morfología superficial.}\\
			\footnotesize{$^\mathsection$ Valores de $n$ para las paredes de los sistemas mesoporosos a $\lambda\index{longitud de onda}=$\SI{600}{\nm}; $n_{SiO_2}=1,45$.}\\
