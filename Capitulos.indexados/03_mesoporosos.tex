...
\section{Métodos alternativos de síntesis de \pdm}
	...
	\subsection{Método por calcinación\index{calcinación}}
	 ...
	 \subsection{Método alcalino}
		 ...
		 Los depósitos obtenidos sobre Au\index{oro} presentan grandes grietas y zonas muy fraccionadas para ambos sistemas porosos, \pdmF\space y \pdmC. Esta observación se atribuye nuevamente a la violenta condensación\index{condensación} catalizada por el medio, en este caso fuertemente alcalino. Sobre silicio\index{silicio} las \pdm\space resultaron en depósitos homogéneos y de buen aspecto tanto por microscopia\index{microscopía}\index{microscopía}\index{microscopía!óptica} como electrónica (figuras \ref{fig:Microscopia_F127_basico} y \ref{fig:Microscopia_CTAB_basico}).
	 ...
	 \subsection{Comparación de resultados}
			 ...
			 \toprule
				 ...
				 VacSF   &\cmark&\cmark&& 9,0 & 4,0  & 38 & 223 & 1,383 & 42,5 \\
				 VacZSF  &\cmark&\cmark&&  -  &  -	 & -  &  -  &    -  &   -  \\ \midrule	
			...
			\toprule
				 ...
				 VacSF   & 0,78  & 88,0 & \cmark &   \\ 
				 VacZSF  &   -   &   -  & \cmark &   \\ \midrule
...
\section{Discusión sobre los métodos}
	...
	\subsection{Sobre la extracción\index{extracción}}
		...
		Por este motivo, luego de la extracción\index{extracción} con 2-propanol, se realizó un enjuague sobre las muestras con H$_2$O ligeramente acidificada con HCl\index{acido@ácido!clohídrico} (pH$\approx 2$), de forma de no afectar al óxido, y poder terminar de extraer residuos de surfactante\index{surfactante} o propanol ligado a la estructura. 
			...
			\begin{figure}[ht!]
			\begin{center}
			\includegraphics[width=0.70\textwidth]{Graficos/IR_F127_vacio_AGUA.pdf}
			\caption[FTIR extracción\index{extracción} agua ácida.]{IR correspondiente a una \pdmF\space en cada etapa de eliminación\index{eliminación} del surfactante\index{surfactante} sintetizada por el método de alto vacio\index{alto@alto vacío}.}
			\label{fig:IR_agua}
			\end{center}
			\end{figure}
	...
	\subsection{Sobre la respuesta electroquímica\index{electroquimico}}
		 ...
		 Una parte fundamental en la fabricación de las \pdm\space y su potencial uso para sensores\index{sensor} electroquímico\index{electroquimico}s\index{electroquimico} es la accesibilidad\index{accesibilidad} de moléculas dentro de la red porosa. Ya se demostró, en la sección \ref{sec:acc}, \pageref{sec:acc} que el \aminorutenio\space es capaz de difundir en sistemas calcinados hasta la superficie\index{superficie} del electrodo donde tiene lugar la reacción electroquímica\index{electroquimico}. 

		 El objetivo es evaluar la accesibilidad\index{accesibilidad} en sistemas de poros no calcinados, y compararlos con los calcinados. Los mediciones electroquímica\index{electroquimico}s\index{electroquimico} se llevaron a cabo en películas depositadas, condensadas y extraídas con el tratamiento de alto vacio\index{alto@alto vacío}, ya que es el que mostró las mejores condiciones de adherencia\index{adherencia} al Au, condensación\index{condensación} y distribución de poros. En las figuras .... se exponen los voltagramas comparando \pdmF\space condensadas por calcinación\index{calcinación} y por el método de alto vacio\index{alto@alto vacío}, a dos concentraciones de sonda\index{sonda} diferente.
