...
\section{Discusión sobre los métodos}
	...
	\subsection{Sobre la condensación\index{condensación}}
		...
		Una de las dos técnicas utilizadas para evaluar la condensación\index{condensación} fue elipsoporosimetria ambiental (PEA) mediante la cual se construye una isoterma\index{isoterma} donde se gráfica índice de refracción\index{indice@índice de refracción} en función de la presión parcial de H$_2$O. De dicho técnica se puede extraer el índice de refracción\index{indice@índice de refracción} del SiO$_2$ poroso ponderando su porosidad, según la aproximación de Bruggeman\index{Bruggeman}, la cuál debe satisfacer la ecuación \ref{eq:bruggeman} \cite{Bruggeman1935}. Este valor, comparado con el sistema calcinado, nos da una idea de cuán condensada está la película. También se obtienen información cuantitativa sobre la porosidad\index{porosidad} y el diámetro de poro\index{poro} y cuello\index{cuello de poro}. En las figuras \ref{fig:todos_EPA_F127} y \ref{fig:todos_EPA_CTAB} se comparan todas las isoterma\index{isoterma}s para cada uno de los sistemas, estructurado con CTAB y con F127. Y en la figura \ref{fig:histogramas} se presentan histrogramas compararndo las magnitudes mas relevantes para extraer conclusiones sobre los métodos experimentados.

		Todos los métodos ensayados para sistemas, \pdmF\space y \pdmC, resultaron en películas porosas. Sin embargo para el F127, muchos de los tratamientos (simplificado, ácido\index{acido@ácido} y básico) presentaron doble distribución\index{distribución!doble} de cuello\index{cuello de poro}s, sugiriendo sistemas con doble tamaños de cuello\index{cuello de poro}s o sistemas condensandos parcialmente por sectores con distintas caracteristicas. Para todos los tratamientos, los índices de refracción dan valores similares con óxidos mesoporosos calcinados, indicando una condensación\index{condensación} similar a éstos. 
			...
			\begin{figure}[th!]
		 	   	   \begin{center}
		 	   	   \includegraphics[width=0.75\textwidth]{Graficos/SI_F127_todos_EPA.pdf}
