...
\section{Métodos alternativos de síntesis de \pdm}
	...
	\subsection{Método por calcinación\index{calcinación}}
	 ...
	 \subsection{Método prolongado}
	 	 ...
	 	 Este tratamiento se basó en tiempos de condensación\index{condensación} prolongados. Luego de la estabilización de las \pdm\space en cámara de humedad se dejó \SI{130}{\celsius} por el término de 7 para llevar a cabo la extracción\index{extracción} del surfactante\index{surfactante}.

	 	 Se lograron sintetizar sobre silicio\index{silicio} películas homogéneas, sin discontinuidades ni grietas y de poros bien formados para ambos surfactante\index{surfactante}s. Cuando se utilizó Au\index{oro} como soporte, solo se obtuvieron películas de buen aspecto para aquellas estructuradas con F127. Para las estructuradas con CTAB se observaron grietas y sectores enteros completamente desprendidos de los electrodos. Nuevamente, al igual que en el tratamientos anterior, este hecho sugiere que la micelas de CTAB impiden la adhesión de las \pdmC\space a los electrodos (figuras \ref{fig:Microscopia_F127_prolongado} y \ref{fig:Microscopia_CTAB_prolongado}).
