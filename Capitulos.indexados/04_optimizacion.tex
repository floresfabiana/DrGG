...
\section{Tratamientos alternativos a bajas temperaturas}
	...
	\subsection{Tratamiento alto vacio\index{alto@alto vacío}}\label{sec:trat-vacio}
		...
		\begin{figure}[!ht]
				...
				\end{subfigure}
				\caption[Elipsoporosimetría \pdmF\space tratamiento alto vacio\index{alto@alto vacío}.]{Resultados de elipsoporosimetría\index{elipsoporosimetría ambiental} ambiental para una \pdmF\space sintetizada por el tratamientos prolongado, 7 días a \SI{130}{\celsius} en alto vacio\index{alto@alto vacío} (P=\SI{1e-5}{\milli\bar}).}
				\end{figure}
		...
		\pagebreak		     
 		...
 		\begin{figure}[!ht]
			...
			\end{subfigure}
			\caption[Elipsoporosimetría \pdmC\space tratamiento alto vacio\index{alto@alto vacío}.]{Resultados de elipsoporosimetría\index{elipsoporosimetría ambiental} ambiental para una \pdmC\space sintetizada por el tratamientos prolongado, 7 días a \SI{130}{\celsius} en alto vacio\index{alto@alto vacío} (P=\SI{1e-5}{\milli\bar}).}
			\end{figure} 	
