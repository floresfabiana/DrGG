...
set terminal tikz
set output "EQ-sensado-Ru.tikz" 

#Saco la leyenda
	set key top left Left reverse font ",8" textcolor rgb "black"
...
set style line 1 lc rgb 'gray60' pt 7 lt 1 ps 0.75 lw 0.5 #Marron
set style line 2 lc rgb 'red' pt 7 lt 1 ps 0.75 lw 2.5 #ROjo
set style line 3 lc rgb 'blue' pt 7 lt 1 ps 0.75 lw 1 #Azul
set style line 4 lc rgb 'green' pt 7 lt 1 ps 0.75 lw 1 #Azul
set style line 5 lc rgb 'black' pt 7 lt 1 ps 0.75 lw 1 #Azul
...
#Coloca los nombre de los ejes
	set xlabel "$\\text{Potencial Pico Anodico}$" font ",14" textcolor rgb "gray40" offset  0,-2
	set ylabel "$\\text{j\\textsubscript{pico}}/ \\mu \\text{A.cm}^{-2}$"	   font ",14" textcolor rgb "gray40" offset -2,0
...
"APTES-10mM-ciclos-1-45.txt" u 2:($5/0.0314) ls 3 title "APTES 10mM", \
"APTES-10mM-ciclos-45-90.txt" u 2:($5/0.0314) ls 3 notitle, \
"APTES-10mM-ciclos-90-135.txt" u 2:($5/0.0314) every ::5::45 ls 3 notitle, \
"APTES-1mM-ciclos-1-45.txt" u 2:($5/0.0314) ls 4 title "APTES 1mM", \
"APTES-1mM-ciclos-45-90.txt" u 2:($5/0.0314) ls 4 notitle, \
"APTES-1mM-ciclos-90-135.txt" u 2:($5/0.0314) ls 4 notitle, \
"DHDP-3mM-ciclos-1-45.txt" u 2:($5/0.0314) ls 5 notitle, \
"DHDP-3mM-ciclos-45-90.txt" u 2:($5/0.0314) ls 5 title "DHDP 3mM",\
"Zr-Meso-Bis.txt" u 2:($5/0.0314) every ::1::150 ls 1 title "Sin funcionalizar"