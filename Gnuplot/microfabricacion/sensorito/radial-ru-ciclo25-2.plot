...
set terminal tikz 
set output "radial-ru-ciclo25-2.tikz" 
...
set label "Ciclo 25" at 1.5*cos(90),1.5*sin(90) center font ",26"
...
#Grafico
plot "radial-ru2.txt" u 3:5 with filledcurve ls 13 t "ciclo 25"