...
set terminal tikz 
set output "radial-fecn-ciclo1-2.tikz" 
...
set label "FeCN" at 1.2*cos(135),1.2*sin(120) center font ",26"
...
#Grafico
plot "radial-fecn2.txt" u 3:4 with filledcurve ls 13 t "ciclo 1"