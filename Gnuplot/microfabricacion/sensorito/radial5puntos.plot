...
set style line 11 lc rgb 'gray50' lt 1 lw 2 pt 2 ps 2 #set the line style for the plot
set style line 12 lc rgb 'blue' lt 1 lw 2 pt 2 ps 2 
set style line 13 lc rgb 'red' lt 1 lw 2 pt 2 ps 2 
set style fill transparent solid 0.35 

#and finally the plot
plot "radial-ru.txt" u 2:3 t "Max strain" with filledcurve ls 11, "radial-ru.txt" u 2:4 t "Max strain" with filledcurve ls 12, "radial-ru.txt" u 2:5 t "Max strain" with filledcurve ls 13
