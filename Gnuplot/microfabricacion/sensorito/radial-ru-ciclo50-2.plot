...
set terminal tikz 
set output "radial-ru-ciclo50-2.tikz" 
...
set label "(0:4)" at 1.1*cos(90) , 1.1*sin(90) center offset char 0,1
set label "(0:4)" at 1.1*cos(180) , 1.1*sin(180) center offset char 2,-1
...
set label "Ciclo 50" at 1.5*cos(90),1.5*sin(90) center font ",26"
...
#Grafico
plot "radial-ru2.txt" u 3:6 with filledcurve ls 13 t "ciclo 50"