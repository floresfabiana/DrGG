...
set terminal tikz 
set output "radial-fecn-ciclo1.tikz" 
...
set label "(-400:400)" at 4.3*cos(360) , 4.3*sin(360) center offset char 10,0
...
#Grafico
plot "radial-fecn.txt" u 3:4 with filledcurve ls 11 t "ciclo 1"
