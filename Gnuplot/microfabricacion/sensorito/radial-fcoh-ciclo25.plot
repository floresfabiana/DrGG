...
set terminal tikz 
set output "radial-fcoh-ciclo25.tikz" 
...
set label "(-400:400)" at 4.3*cos(360) , 4.3*sin(360) center offset char 5,0
...
#Grafico
plot "radial-fcoh.txt" u 3:5 with filledcurve ls 11 t "ciclo 25"
