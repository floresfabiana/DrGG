...
#Grafico
plot 'histogramas-ciclos25-50.txt' using 3:xtic(1) lc 'gray20' title "Fe", 'histogramas-ciclos25-50.txt' using 5:xtic(1) lc 'orange' title "Fc", 'histogramas-ciclos25-50.txt' using 7:xtic(1) lc 'blue' fs pattern 1 title "ARu",