...
set terminal tikz
set output "Concentraciones_HQ.tikz" 
...
plot "Concentraciones_HQ.txt" using ($1):($3/0.0314) with lines ls 3,"Concentraciones_HQ.txt" using ($1):($2/0.0314) with  lines ls 2, "Concentraciones_HQ.txt" using ($1):($4/0.0314) with lines ls 1
