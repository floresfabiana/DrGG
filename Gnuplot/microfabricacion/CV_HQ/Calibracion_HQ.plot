...
#FITEO
	...
	set label 1 sprintf("y=%3.3f %3.3f",a,b) at 0.2,2800 font ",10" textcolor rgb "gray20"
	set label 2 sprintf("R=%3.4f",STATS_correlation) at 0.2,2500 font ",10" textcolor rgb "gray20"
