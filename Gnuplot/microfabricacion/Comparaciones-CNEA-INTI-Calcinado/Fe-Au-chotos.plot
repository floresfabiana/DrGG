...
set terminal tikz
set output "Fe-Au-chotos.tikz" 

#Saco la leyenda
set key top left Left reverse sample 1.8 font ",14" textcolor rgb "black" at -180,125
...
plot "Au-INTI-Calcinado.txt" using ($1):($2/0.0314) with lines ls 3 title "[Fe(CN)$_6]^{4-}$\\textsuperscript{/}$^{3-}$", \
