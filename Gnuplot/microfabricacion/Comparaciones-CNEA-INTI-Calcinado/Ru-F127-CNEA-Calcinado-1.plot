...
#Defino estilos paset style line 2ra cada tipo de linea
	...
	set style line 1 lc rgb 'salmon' lt 1 lw 0.5 #Marron
...
plot "Au CNEA F127 Calcinado Ru1mM.txt" using ($1):($2/0.0314) every 3  with lines ls 1, \
"Au CNEA F127 Calcinado Ru1mM.txt" using ($3):($4/0.0314)  every 3 with lines ls 1, \
"Au CNEA F127 Calcinado Ru1mM.txt" using ($5):($6/0.0314) every ::12600::14000  with lines ls 2, \
