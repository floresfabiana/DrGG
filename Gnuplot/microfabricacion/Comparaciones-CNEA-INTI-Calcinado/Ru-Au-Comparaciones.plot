...
plot "datos-Au-calciando-INTI-CNEA.txt" using ($7):($8/0.0314)  with lines ls 3, \
"datos-Au-calciando-INTI-CNEA.txt" using ($9):($10/0.0314) with lines ls 2, \
"datos-Au-calciando-INTI-CNEA.txt" using ($11):($12/0.0314) with lines ls 1
