...
set terminal tikz
set output "Ru-F127-INTI-Calcinado-1.tikz" 
...
plot "datos-AU-INTI-Calcinado-F127.txt" using ($1):($2/0.0314) every 5 with lines ls 3, \
"datos-AU-INTI-Calcinado-F127.txt" using ($3):($4/0.0314) every 5 with lines ls 1, \
