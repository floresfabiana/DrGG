...
set terminal tikz
set output "Fe-Au-Comparaciones.tikz" 

#Saco la leyenda
set key bottom right Left reverse sample 1.8 font ",14" textcolor rgb "black" at 700,-150
#Saco el Borde
	unset border
...
plot "Au-INTI-Calcinado.txt" using ($1):($2/0.0314) with lines ls 2 title "Au3N Calcinado", \
"Au-INTI-TAmbiente.txt" using ($1):($2/0.0314*0.94) w l ls 1 title "Au3N Sin Calcinar", \
"Au-CNEA-Calcinado.txt" using ($1):($2/0.0314) with lines ls 3 title "Au4N Calcinado", \
