...
set terminal tikz
set output "Ru-Au-chotos.tikz" 

#Saco la leyenda
set key top left Left reverse sample 1.8 font ",14" textcolor rgb "black" at -580,75
...
plot "datos-Au-calciando-INTI-CNEA.txt" using ($7):($8/0.0314)  with lines ls 3  title "[Ru(NH$_3$)$_6]^{3+}$",\
