...
plot "Calibracion_Ru.txt" using ($1):($2/0.0314) with points ls 1,"Calibracion_Ru.txt" using ($1):($3/0.0314) with  points ls 1, f(x) with lines ls 4, g(x) with lines ls 4
