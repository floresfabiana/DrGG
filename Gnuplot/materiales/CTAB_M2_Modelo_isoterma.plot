...
set label "adsorción" at 0.50,1.35 rotate by 76 font ",16" textcolor rgb 'gray20'
set label "desorción" at 0.33,1.348 rotate by 76 font ",16" textcolor rgb 'gray20'
#Coloca los nombre de los ejes
set xlabel "$\\text{P/P}_s$" font ",16" textcolor rgb "gray20" offset  0,-2
set ylabel "\'Indice de refracci\'on" font ",16" textcolor rgb "gray20" offset  -2,0
