...
#Leyenda
set label "cuellos" at 0.9,2.75  font ",16" textcolor rgb "gray20"
set label "poros" at 2.9,2.75  font ",16" textcolor rgb "gray20"
#set label "b" at 0.1,3.2  font ",24" textcolor rgb "black"

#Coloca los nombre de los ejes
set xlabel "Di\'ametro" font ",18" textcolor rgb "gray20" offset  0,-2
set ylabel "Poblaci\'on relativa" font ",18" textcolor rgb "gray20" offset  -2,0
