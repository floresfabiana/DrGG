...
#Para graficar todas
plot "DHDP3mM/Ru.txt" using 1:($2/0.0314) every 5 with lines ls 1,\
"DHDP3mM/Ru.txt" using 5:($6/0.0314) every 5 with lines ls 3,\
"DHDP3mM/Ru.txt" using 7:($8/0.0314) every 5 with lines ls 3,\
