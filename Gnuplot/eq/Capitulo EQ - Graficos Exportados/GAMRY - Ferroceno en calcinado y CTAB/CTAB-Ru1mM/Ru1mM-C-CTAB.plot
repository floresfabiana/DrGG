...
FILES = system("ls -1 CTAB-Ru1mM*DTA*.txt")

plot for [data in FILES] data u 1:($2/0.0314*1e6) with lines ls 1,  "CTAB-Ru1mM-control.txt" u 3:($4/0.0314*1e6) with lines ls 5