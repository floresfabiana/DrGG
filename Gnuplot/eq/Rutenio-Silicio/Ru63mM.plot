...
#Para graficar todas
plot for [i=1:3:2] 'Ru63mM.txt' using i:(column(i+1)/0.0314) w lines ls 1, \
'Ru63mM.txt' using 7:($8/0.0314) w lines ls 3, \
'Ru63mM.txt' using 9:($10/0.0314) w lines ls 2
