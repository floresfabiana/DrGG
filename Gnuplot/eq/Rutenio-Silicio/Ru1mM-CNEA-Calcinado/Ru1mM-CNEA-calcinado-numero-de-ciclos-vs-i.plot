...
#set terminal tikz
#set output "Ru1mM-CNEA-calcinado-numero-de-ciclos-vs-i.tikz" 
...
#/6
plot "Ru1mM-CNEA-calcinado-numero-de-ciclos-vs-i.txt" u ($4*(-1)) w p ls 1 title "SF Calcinado - Ru \\SI{1}{\\milli\\Molar}",\
#"Ru1mM-CNEA-calcinado-numero-de-ciclos-vs-i.txt" u ($1):($5) w p ls 2 title "SF Calcinado - Ru \\SI{1}{\\milli\\Molar}",\
