...
#Para graficar todas
plot for [i=1:3:2] 'Ru315mM.txt' using i:(column(i+1)/0.0314) every 2 w lines ls 1, \
'Ru315mM.txt' using 5:($6/0.0314) w lines ls 3, \
'Ru315mM.txt' using 19:($20/0.0314) w lines ls 2
