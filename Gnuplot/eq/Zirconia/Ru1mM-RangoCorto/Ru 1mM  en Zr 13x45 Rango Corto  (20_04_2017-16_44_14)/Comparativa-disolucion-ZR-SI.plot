...
plot "Zr-Ru1mM-IvsCiclos.txt" u 1:($5/6.05) w p ls 1, [0:600] f(x) w l ls 2, "Ru1mM-secuencia-continua-hasta disolucion-ventana-trabajo.txt" using ($1):($3/4.01) with p ls 1
