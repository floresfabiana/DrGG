...
#set terminal tikz
#set output "Vel-tmp_Fc10mM500-10000.tikz" 
...
#plot "fc-10mM/FC_10mM_F127_10.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 1 title "Fc 10mM, 10 mV/s",\
#"fc-10mM/FC_10mM_F127_20.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 2 title "Fc 10mM, 20 mV/s",\
#"fc-10mM/FC_10mM_F127_50.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 3 title "Fc 10mM, 50 mV/s",\
#"fc-10mM/FC_10mM_F127_100.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 4 title "Fc 10mM, 100 mV/s",\
#"fc-10mM/FC_10mM_F127_200.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 5 title "Fc 10mM, 200 mV/s",\

plot "fc-10mM/FC_10mM_F127_500.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 1 title "Fc 10mM, 500 mV/s",\
"fc-10mM/FC_10mM_F127_1000.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 2 title "Fc 10mM, 1000 mV/s",\
"fc-10mM/FC_10mM_F127_2000.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 3 title "Fc 10mM, 2000 mV/s",\
"fc-10mM/FC_10mM_F127_5000.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 4 title "Fc 10mM, 5000 mV/s",\
"fc-10mM/FC_10mM_F127_10000.DTA-Ciclo-1" using ($1):($2/0.0314) with lines ls 5 title "Fc 10mM, 10000 mV/s",\
