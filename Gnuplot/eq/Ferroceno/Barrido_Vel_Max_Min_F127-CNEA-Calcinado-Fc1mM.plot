...
set terminal tikz
set output "Barrido_Vel_Max_Min_F127-CNEA-Calcinado-Fc1mM.tikz"
...
plot "Barrido_Vel_Max_Min_F127-CNEA-Calcinado-Fc1mM.txt" using (log10($1)):(log10($3)) with points ls 1 title "Corriente \'anodica", f(x) with lines ls 1 notitle, \
"Barrido_Vel_Max_Min_F127-CNEA-Calcinado-Fc1mM.txt" using (log10($1)):(log10($5)) with points ls 2 title "Corriente cat\'odica", g(x) with lines ls 2 notitle #h(x) with lines ls 2 notitle