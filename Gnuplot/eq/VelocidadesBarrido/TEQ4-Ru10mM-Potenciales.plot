...
set terminal tikz
set output "TEQ4-Ru10mM-Potenciales.tikz"
...
plot "TEQ4-Ru10mM-Max-Min.txt" using 1:2 with points ls 1 title "Potencial \'anodico", \
"TEQ4-Ru10mM-Max-Min.txt" using 1:4 with points ls 2 title "Potencial cat\'odico"