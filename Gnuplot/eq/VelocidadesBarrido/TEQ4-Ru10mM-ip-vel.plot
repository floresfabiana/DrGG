...
set terminal tikz
set output "TEQ4-Ru10mM-ip-vel.tikz"
...
plot "TEQ4-Ru10mM-Max-Min.txt" using 1:(($3/$1)/(-4.83/3)) with points ls 1 title "Pico \'anodico", \
"TEQ4-Ru10mM-Max-Min.txt" using 1:(($5/$1)/(-9.919/3)) with points ls 2 title "Pico cat\'odico"