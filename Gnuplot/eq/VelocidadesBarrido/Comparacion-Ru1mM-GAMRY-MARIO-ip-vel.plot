...
set style line 3 lc rgb 'green' pt 7 ps 1  #Circulo
...
plot "MARIO-Ru1mM-Max-Min-Corregido.txt" using 1:(($4/$1)/(-0.1/3)) with points ls 1 title "Pico \'anodico", \
"MARIO-Ru1mM-Max-Min-Corregido.txt" using 1:(($6/$1)/(-0.1/3)) with points ls 2 title "Pico cat\'odico",\
"GAMRY-Ru1mM-Max-Min.txt" using 1:(($3/$1)/(-0.1/3)) with points  ls 3 title "Pico \'anodico", \
"GAMRY-Ru1mM-Max-Min.txt" using 1:(($5/$1)/(-0.1/3)) with points ls 4 title "Pico cat\'odico"