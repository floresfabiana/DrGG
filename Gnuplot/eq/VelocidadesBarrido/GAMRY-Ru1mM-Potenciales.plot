...
set terminal tikz
set output "GAMRY-Ru1mM-Potenciales.tikz"
...
#Coloca los nombre de los ejes
	...
	set ylabel "Potencial vs ESC / mV"	font ",14" textcolor rgb "gray40" offset -2,0
...
plot "GAMRY-Ru1mM-Max-Min.txt" using 1:2 with points ls 1 title "Potencial \'anodico", \
"GAMRY-Ru1mM-Max-Min.txt" using 1:4 with points ls 2 title "Potencial cat\'odico"