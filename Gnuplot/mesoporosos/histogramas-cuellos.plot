...
set output "histogramas-cuellos.tikz" 
set key right Left reverse samplen 3 font ",14"   textcolor rgb "gray20" width 2
...
#Coloca los nombre de los ejes
	set ylabel "diámetro de cuello / nm"  font ",16" textcolor rgb "gray20" offset -2,0
...
#Grafico
plot 'histogramas.txt' using 3:10:xtic(1) lc 'gray20' title "SC",\
'histogramas.txt' using 7:10:xtic(1) lc 'orange' title "SF",