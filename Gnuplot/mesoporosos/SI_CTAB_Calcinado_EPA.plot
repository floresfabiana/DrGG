...
set terminal tikz
set output "SI_CTAB_Calcinado_EPA.tikz" 
...
plot "SI_CTAB_Calcinado_EPA.txt" using 1:2 axes x1y1 with linespoints ls 1 title "Adsorci\'on", "SI_CTAB_Calcinado_EPA.txt" using 5:6 with linespoints ls 3 title "Desorci\'on"
