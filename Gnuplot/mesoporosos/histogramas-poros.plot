...
#Coloca los nombre de los ejes
	set ylabel "diámetro de poro / nm"  font ",14" textcolor rgb "gray40" offset -2,0
...
#Grafico
plot 'histogramas.txt' using 2:9:xtic(1) lc 'gray20' title "SC",\
'histogramas.txt' using 6:10:xtic(1) lc 'orange' title "SF",