...
plot "SI_F127_Calcinado_EPA.txt" using 1:($2-0.003) axes x1y1 with linespoints ls 1 title "Adsorci\'on", "SI_F127_Calcinado_EPA.txt" using 5:6  with linespoints ls 3 title "Desorci\'on"
