...
plot "SI_F127_Calcinado_PSD.txt" using ($1*2):2 with linespoints ls 1 title "Di\'ametro de poros", "SI_F127_Calcinado_PSD.txt" using ($3*2):4 with linespoints ls 3 title "Di\'ametro de cuellos"
