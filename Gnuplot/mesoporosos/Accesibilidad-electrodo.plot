...
set terminal tikz 
set output "Accesibilidad-electrodo.tikz" 
...
#Coloca los nombre de los ejes
	set xlabel "$\\text{Tensi\'on\\; vs\\; ESC/}mV$" font ",14" textcolor rgb "gray40" offset  0,-2
...
plot  'Ru-0.315mM-adsorbido.txt' using 1:($2/0.0314) with lines ls 1
