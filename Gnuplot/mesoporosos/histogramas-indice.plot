...
set output "histogramas-indice.tikz" 
...
#Coloca los nombre de los ejes
	set ylabel "indice de refracción"  font ",14" textcolor rgb "gray40" offset -2,0
...
set ytics font ",12" format "%1.3f"
set boxwidth 0.95 relative
set yrange [1.36:1.40]

#set label 100 at 8.8,0.6 "567" font ",8" rotate by 90
#set label 200 at 9.17,0.2 "294" font ",8" rotate by 90

#Grafico
plot 'histogramas.txt' using 5:13:xtic(1) lc 'gray20' title "SC",\
'histogramas.txt' using 9:13:xtic(1) lc 'orange' title "SF",