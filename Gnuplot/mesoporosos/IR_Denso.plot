...
set label "$\\nu_{\\text{\\tiny{Si-O-Si}}}$" at 970,0.225 font ",8" textcolor rgb "gray40"
set label "\\tiny{TO$_2$}" at 900,0.20 font ",8" textcolor rgb "gray40"

set label "$\\nu_{\\text{\\tiny{Si-O-Si}}}$" at 970,0.055 font ",8" textcolor rgb "gray40"
set label "\\tiny{TO}$_2$" at 900,0.03 font ",8" textcolor rgb "gray40"

set label "$\\nu_{\\text{\\tiny{Si-OH}}}$" at 1010,0.1 font ",10" textcolor rgb "gray40"

set label "$\\nu_{\\text{\\tiny{Si-O-Si}}}$" at 1250,0.505 font ",8" textcolor rgb "gray40"
...
set label "\\tiny{H$_2$O}" at 1700,0.025 font ",8" textcolor rgb "gray40"
...
# Now we set the options for the smaller plot
  ...
  set label "$\\nu_{\\text{\\tiny{Si-O-Si}}}$" at 1300,0.555 font ",8" textcolor rgb "gray40"
  set label "\\tiny{LO}$_3$" at 1280,0.547 font ",8" textcolor rgb "gray40"

  set label "$\\nu_{\\text{\\tiny{Si-O-Si}}}$" at 1230,0.533 font ",8" textcolor rgb "gray40"
