...
set terminal tikz
set output "SI_F127_Calcinado_ESP.tikz" 
...
plot "SI_F127_Calcinado_EPA.txt" using 1:3 with linespoints ls 1 title "Adsorci\'on", "SI_F127_Calcinado_EPA.txt" using 5:7 with linespoints ls 3 title "Desorci\'on"
