...
set style line 6 lc rgb 'gray20' lt 1 lw 1 pt 11 ps 1 #Naranja
...
set xlabel "$\\text{P/P}_s$" font ",14" textcolor rgb "gray20" offset  0,-2
set ylabel "\'Indice de refracci\'on" font ",14" textcolor rgb "gray20" offset  -2,0
#set y2label "\\% Volumen Poroso" font ",14" textcolor rgb "gray20" offset  2,0
...
plot "Si_EtCTAB-EPA.txt" using 1:2 with linespoints ls 6 title "SimSC",\
"Si_EtCTAB-EPA.txt" using 5:6 with linespoints ls 6 notitle,\
"Si_130CTAB-EPA.txt" using 1:2 with linespoints ls 5 title "ProSC",\
...
"Si_CCTAB-EPA.txt" using 1:2 with linespoints ls 3 title "CalSC",\
"Si_CCTAB-EPA.txt" using 5:6 with linespoints ls 3 notitle,\
"Si_CCTAB-EPA.txt" using 1:2 with points ls 300 notitle,\
"Si_CCTAB-EPA.txt" using 5:6 with points ls 300 notitle
