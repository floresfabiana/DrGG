...
set terminal tikz
set output "IR_F127_prolongado.tikz" 
...
set label "ProSF extraído" at 4000,0.04 font ",8" textcolor rgb "black"
set label "ProSF s/extraer" at 4000,-0.04 font ",8" textcolor rgb "black"

#Ploteo todas las funciones que les digamos
plot "Si_130F127.CSV" using ($1):($2-0.05) with lines ls 1 title "PDM@Si-F127 sin extraer", "Si_130F127_extraido.CSV" using 1:2 with lines ls 3 title "PDM@Si-F127 extraido"
...
#Inset con la extracción
  ...
  unset arrow
  unset key
  plot "Si_130F127.CSV" using 1:($2-0.065) with lines ls 1 title "PDM@Si-CTAB sin extraer", "Si_130F127_extraido.CSV" using 1:($2-0.0985) with lines ls 3 title "PDM@Si-CTAB extraido"
  unset multiplot