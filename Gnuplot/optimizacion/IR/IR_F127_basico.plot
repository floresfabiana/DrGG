...
set terminal tikz
set output "IR_F127_basico.tikz" 
...
set label "AlcSF extraído" at 4000,0.11 font ",8" textcolor rgb "black"
set label "AlcSF s/extraer" at 4000,0.015 font ",8" textcolor rgb "black"

#Ploteo todas las funciones que les digamos
plot "Si_BF127.CSV" using ($1):($2) with lines ls 1 title "PDM@Si-F127 sin extraer", "Si_BF127_extraido.CSV" using 1:($2+0.12) with lines ls 3 title "PDM@Si-F127 extraido"
...
#Inset con la extracción
  ...
  unset arrow
  unset key
  plot "Si_BF127.CSV" using 1:($2-0.065) with lines ls 1 title "PDM@Si-CTAB sin extraer", "Si_BF127_extraido.CSV" using 1:($2-0.055) with lines ls 3 title "PDM@Si-CTAB extraido"
  unset multiplot