...
set terminal tikz
set output "IR_CTAB_prolongado.tikz" 
...
plot "Si_130CTAB.CSV" using ($1):($2) with lines ls 1 title "PDM@Si-CTAB sin extraer", "Si_130CTAB_extraido.CSV" using 1:($2+0.15) with lines ls 3 title "PDM@Si-CTAB extraido"
...
#Inset con la extracción
  ...
  unset arrow
  unset key
  plot "Si_130CTAB.CSV" using 1:2 with lines ls 1 title "PDM@Si-CTAB sin extraer", "Si_130CTAB_extraido.CSV" using 1:($2-0.007) with lines ls 3 title "PDM@Si-CTAB extraido"
  unset multiplot