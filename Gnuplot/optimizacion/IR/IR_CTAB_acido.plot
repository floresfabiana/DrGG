...
#Inset con la extracción
  ...
  unset arrow
  unset key
  plot "Si_ACTAB.CSV" using 1:2 with lines ls 1 title "PDM@Si-CTAB sin extraer", "Si_ACTAB_extraido.CSV" using 1:($2-0.05) with lines ls 3 title "PDM@Si-CTAB extraido"
  unset multiplot