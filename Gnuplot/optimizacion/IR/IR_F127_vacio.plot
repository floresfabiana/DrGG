...
#Inset con la extracción
  ...
  unset arrow
  unset key
  plot "Si_130VF127.CSV" using 1:($2-0.065) with lines ls 1 title "PDM@Si-CTAB sin extraer", "Si_130VF127_extraido.CSV" using 1:($2-0.1005) with lines ls 3 title "PDM@Si-CTAB extraido"
  unset multiplot