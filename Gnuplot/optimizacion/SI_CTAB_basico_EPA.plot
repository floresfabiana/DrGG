...
set terminal tikz
set output "SI_CTAB_basico_EPA.tikz" 

#Saco la leyenda
set key top left Left reverse samplen 2 font ",14" textcolor rgb "black" at -0.02,1.379
#Saco el Borde
unset border
...
plot "Si_BCTAB-EPA.txt" using 1:2 axes x1y1 with linespoints ls 1 title "Adsorci\'on", "Si_BCTAB-EPA.txt" using 5:6 with linespoints ls 3 title "Desorci\'on"
