...
set terminal tikz
set output "SI_F127_vacio_EPA.tikz" 
...
plot "Si_130VF127-EPA.txt" using 1:($2-0.04) with linespoints ls 1 title "Adsorci\'on", "Si_130VF127-EPA.txt" using 5:($6-0.04) with linespoints ls 3 title "Desorci\'on"
