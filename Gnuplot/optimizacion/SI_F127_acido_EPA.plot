...
set terminal tikz
set output "SI_F127_acido_EPA.tikz" 
...
plot "Si_AF127-EPA.txt" using 1:2 axes x1y1 with linespoints ls 1 title "Adsorci\'on", "Si_AF127-EPA.txt" using 5:6 with linespoints ls 3 title "Desorci\'on"
