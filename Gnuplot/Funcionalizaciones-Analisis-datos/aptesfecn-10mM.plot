...
set terminal tikz
set output "aptesfecn-10mM.tikz" 
...
"APTES/FeCN.txt" u 3:($4/0.0314) every 10::18000::53000 w l ls 1 notitle,\
"APTES/FeCN.txt" u 5:($6/0.0314) every 10 w l ls  3 title "SZF$^N_{10}$",\
"APTES/FeCN.txt" u 7:($8/0.0314) every 10::1::41000 w l ls 3  notitle
