...
\chapter*{Anexo A: información suplementaria}
    ...
    %Simplificado
	 ...
	 %Elipso CTAB Simplificad
		  \begin{figure}	
			...
			\caption{Isorterma de adsorción/desorción de agua ralizada por PEA para una Sim\pdmC.}
	...
	%Prolongado
		...
		%Elipso CTAB Prolongado
		 \begin{figure}
			...
			\caption{Isoterma de adsorción/desorción de agua ralizada por PEA para Pro\pdmC\space.}
    ...
    %Básico
		...
		%Elipso CTAB
			...
			\caption[Elipsoporsimetría \pdmC\space tratamiento básico.]{Isoterma de adsorción/desorción de agua realizada por PEA para una Alc\pdmC.}
		...
		%FTIR F127
			...
			\caption[FTIR \pdmF\space tratamiento básico.]{Espectro de absorción en el IR para una Alc\pdmF\space antes y después de extraer el surfactante. Obsérvese la ausencia de hombro en la región 1250-\SI{1100}{\cm^{-1}}, el cual es típico en sistemas de SiO$_2$ mesoestrucuturas.}
		...
		%FTIR CTAB	
			...
			\caption[FTIR \pdmC\space tratamiento básico.]{Espectro de absorción en el IR para una Alc\pdmC\space antes y después de extraer el surfactante. Obsérvese la ausencia de hombro en la región 1250-\SI{1100}{\cm^{-1}}, el cual es típico en sistemas de SiO$_2$ mesoestrucuturas.}
		...
		\clearpage\subsection*{Figuras correspondientes al capítulo \ref{chap:Electroquimica}}
			...
			\caption{Microscopía óptica de una \pdmF\space luego de realizar 90 ciclos electroquímicos. Se puede observar el Au desnudo del electrodo donde se colocó el sello de la celda electroquímica, indicando la disolución de la película mesoporosa.}
		    ...
		    \end{figure} 	
		  	 ...
		  	 \begin{figure}[ht]	
			        ...
			        \begin{subfigure}[t]{0.495\textwidth}
			 	    \vspace*{5mm}
			 	    \includegraphics[width=\textwidth]{Graficos/aptesru-10mM-2.pdf}
			        \caption{Respuesta sobre una \pdmZ\space funcionalizada con APTES \SI{10}{\milli\Molar} utilizando como sonda positiva \aminorutenio\space \SI{1}{\milli\Molar}.}
